      ...
      <div className='flex flex-row w-full h-screen min-h-screen mx-auto'>
          <div className='w-[950px] bg-login-image bg-cover bg-[60%] flex items-end py-10' >
            <div className='w-10/12 mx-auto text-white space-y-6'>
              <div>
                <h1 className=' text-2xl font-semibold text-[#eabc62]'>Rice Farmer's Guide</h1>
                <p>Explore our guides using our advisory tools and training materials and unlock the full potential of your rice farming journey!</p>
              </div>
          ...
          <div className='w-full flex justify-center items-center'>
            <div className='w-[400px] mx-auto space-y-3 mt-10' >
              ...
              <LoginForm />
              <p className='text-center'>Do not have an account yet? <span className='text-[#2c963f] font-semibold cursor-pointer hover:text-[#59b26a]'>Register</span></p>
              <p className='text-center text-[#2c963f] font-semibold cursor-pointer hover:text-[#59b26a]'>Forgot your Password?</p>
            </div>
          </div>
      </div>
    </div>
