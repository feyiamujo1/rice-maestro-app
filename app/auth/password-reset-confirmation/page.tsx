  ...
  return (
    <div className='space-y-4 mb-10 md:mb-0'>
        ...
        <div>
            ...
            <p className='text-center'>Didn't receive any code? <Link href="/auth/forgot-password" className='text-[#2c963f] font-semibold cursor-pointer hover:text-[#59b26a]'>Resend Code</Link></p>
        </div>
    </div>
  )
}
